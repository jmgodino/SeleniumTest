...
import com.picoto.selenium.test.MutualAuthenticationCapableMitmManager.KeyManagerFactoryProvider;
...
public class KeyManagerFactoryProviders {
    static {
    ...
    private static class PEMKeyPairBasedKeyManagerProvider implements KeyManagerFactoryProvider {
        ...
        public KeyManagerFactory create() {
            ...
            try {
                ...
                throw new IllegalStateException("Could not crEate Key Store", e);
            } catch (IOException e) {
